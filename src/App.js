...
const App = () => {
  ...
  const auth = useContext(AuthContext).loggedIn;
  const watchList = useContext(AuthContext).watchList;
  ...
  const movies = [
    ...
    {
      id: 17,
      backgroundImg: "https://c4.wallpaperflare.com/wallpaper/587/697/259/chernobyl-hbo-tv-series-disaster-poster-hd-wallpaper-preview.jpg",
      cardImg: "https://c4.wallpaperflare.com/wallpaper/587/697/259/chernobyl-hbo-tv-series-disaster-poster-hd-wallpaper-preview.jpg",
      description: "When 11-year-old Riley moves to a new city, her Emotions team up to help her through the transition. Joy, Fear, Anger, Disgust and Sadness work together, but when Joy and Sadness get lost, they must journey through unfamiliar places to get back home.",
      subTitle: "2015 • 1h 35m • Coming of Age, Family, Animation",
      title: "Chernoby",
      type: 'series'
    ...
    {
      id: 18,
      backgroundImg: "https://c4.wallpaperflare.com/wallpaper/808/222/455/mr-robot-tv-series-eliot-henrique-petrus-wallpaper-thumb.jpg",
      cardImg: "https://c4.wallpaperflare.com/wallpaper/149/596/863/mr-robot-elliot-mr-robot-tv-fsociety-wallpaper-thumb.jpg",
      description: "When 11-year-old Riley moves to a new city, her Emotions team up to help her through the transition. Joy, Fear, Anger, Disgust and Sadness work together, but when Joy and Sadness get lost, they must journey through unfamiliar places to get back home.",
      subTitle: "2015 • 1h 35m • Coming of Age, Family, Animation",
      title: "Mr. Robot",
      type: 'series'
    ...
    {
      id: 19,
      backgroundImg: "https://c4.wallpaperflare.com/wallpaper/406/324/22/tv-show-peaky-blinders-wallpaper-thumb.jpg",
      cardImg: "https://c4.wallpaperflare.com/wallpaper/666/932/54/tv-show-peaky-blinders-wallpaper-thumb.jpg",
      subTitle: "2015 • 1h 35m • Coming of Age, Family, Animation",
      description: "When 11-year-old Riley moves to a new city, her Emotions team up to help her through the transition. Joy, Fear, Anger, Disgust and Sadness work together, but when Joy and Sadness get lost, they must journey through unfamiliar places to get back home.",
    ...
    {
      id: 20,
      backgroundImg: "https://c4.wallpaperflare.com/wallpaper/575/739/585/game-of-thrones-daenerys-targaryen-drawing-song-of-ice-and-fire-dragon-hd-wallpaper-thumb.jpg",
      cardImg: "https://c4.wallpaperflare.com/wallpaper/115/674/429/throne-game-of-thrones-sean-bean-eddard-ned-stark-tv-posters-george-r-r-martin-song-of-ice-and-f-nature-winter-hd-art-wallpaper-preview.jpg",
      description: "When 11-year-old Riley moves to a new city, her Emotions team up to help her through the transition. Joy, Fear, Anger, Disgust and Sadness work together, but when Joy and Sadness get lost, they must journey through unfamiliar places to get back home.",
      subTitle: "2015 • 1h 35m • Coming of Age, Family, Animation",
      title: "throne game of thrones",
      type: 'series'
    },
  ];
  ...
  return (
    <>
      <Header />
      <Routes>
        <Route path='/' element={<NotLoggedIn><Login /></NotLoggedIn>} />
        <Route path='/home' element={<AuthRequire><Home movies={movies} /></AuthRequire>} />
        <Route path='/movie/:ID' element={<Movie movies={movies} />} />
        <Route path='/watch-list' element={<WatchList movies={watchList} />} />
        <Route path='/originals' element={<WatchList movies={movies.filter(m => m.type === 'recommend')} />} />
        <Route path='/movies' element={<WatchList movies={movies.filter(m => m.type !== 'series')} />} />
        <Route path='/series' element={<WatchList movies={movies.filter(m => m.type === 'series')} />} />
      </Routes>
    </>
  )
}
